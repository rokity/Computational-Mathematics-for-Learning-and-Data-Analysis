...
class SGD:
    ...
    def __init__(self, lr=1e-3, mom=0.0, l2=0.0, decay_lr=None, nesterov=False):
        ...
        @param decay_lr: dictionary composed by the following keys: "epoch_tau", "epsilon_tau".
                         It implements the linear learning rate decay strategy
        @param nesterov: True if you want to use Nesterov momentum
                         False otherwise
        """
        self.lr = lr
        self.momentum = mom
